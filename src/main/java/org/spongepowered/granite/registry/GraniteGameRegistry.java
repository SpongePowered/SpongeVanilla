...
public class GraniteGameRegistry implements GameRegistry {
    ...
    public static final ImmutableMap<String, TextStyle> textStyleMappings = new ImmutableMap.Builder<String, TextStyle>()
            ...
            .put("ITALIC", GraniteTextStyle.of(EnumChatFormatting.ITALIC))
            .put("UNDERLINE", GraniteTextStyle.of(EnumChatFormatting.UNDERLINE))
            .put("STRIKETHROUGH", GraniteTextStyle.of(EnumChatFormatting.STRIKETHROUGH))
            .put("OBFUSCATED", GraniteTextStyle.of(EnumChatFormatting.OBFUSCATED))
            .put("RESET", GraniteTextStyle.of(EnumChatFormatting.RESET))
            .build();
    ...
    private void setArts() {
        /*RegistryHelper.mapFields(Arts.class, new Function<String, Art>() {
            ...
            public Art apply(String fieldName) {
                ...
                GraniteGameRegistry.this.artMappings.put(art.getName(), art);
                return art;
            }
        });*/
    }
    ...
    private void setEntityTypes() {
        ...
        RegistryHelper.mapFields(EntityTypes.class, new Function<String, EntityType>() {
            ...
            public EntityType apply(String fieldName) {
                ...
                EntityType entityType = GraniteGameRegistry.this.entityTypeMappings.get(fieldName);
                GraniteGameRegistry.this.entityClassToTypeMappings.put(((SpongeEntityType) entityType).entityClass, (SpongeEntityType) entityType);
                GraniteGameRegistry.this.entityIdToTypeMappings.put(((SpongeEntityType) entityType).getId(), ((SpongeEntityType) entityType));
                return entityType;
            }
        });
    ...
    private void setDyeColors() {
        /*RegistryHelper.mapFields(DyeColors.class, new Function<String, DyeColor>() {
            ...
            public DyeColor apply(String input) {
                ...
                GraniteGameRegistry.this.dyeColorMappings.put(dyeColor.getName(), dyeColor);
                return dyeColor;
            }
    ...
    private void setFishes() {
        /*RegistryHelper.mapFields(Fishes.class, new Function<String, Fish>() {
            ...
            public Fish apply(String input) {
                ...
                if (fish != null) {
                    GraniteGameRegistry.this.fishMappings.put(fish.getId(), fish);
                    return fish;
                } else {
                    return null;
                }
        ...
        RegistryHelper.mapFields(CookedFishes.class, new Function<String, CookedFish>() {
            ...
            public CookedFish apply(String input) {
                ...
                if (fish != null) {
                    GraniteGameRegistry.this.cookedFishMappings.put(fish.getId(), fish);
                    return fish;
                } else
                    return null;
            }
    ...
    private void setNotePitches() {
        /*RegistryHelper.mapFields(NotePitches.class, new Function<String, NotePitch>() {
            ...
            public NotePitch apply(String input) {
                NotePitch pitch = new SpongeNotePitch((byte) GraniteGameRegistry.this.notePitchMappings.size(), input);
                GraniteGameRegistry.this.notePitchMappings.put(input, pitch);
                return pitch;
            }
    ...
    private void setSkullTypes() {
        /*RegistryHelper.mapFields(SkullTypes.class, new Function<String, SkullType>() {
            ...
            public SkullType apply(String input) {
                SkullType skullType = new SpongeSkullType((byte) GraniteGameRegistry.this.skullTypeMappings.size(), input);
                GraniteGameRegistry.this.skullTypeMappings.put(input, skullType);
                return skullType;
            }
    ...
    private void setBannerPatternShapes() {
        /*RegistryHelper.mapFields(BannerPatternShapes.class, new Function<String, BannerPatternShape>() {
            ...
            public BannerPatternShape apply(String input) {
                ...
                GraniteGameRegistry.this.bannerPatternShapeMappings.put(bannerPattern.getName(), bannerPattern);
                GraniteGameRegistry.this.idToBannerPatternShapeMappings.put(bannerPattern.getId(), bannerPattern);
    ...
    private void setSounds() {
        ...
        /*RegistryHelper.mapFields(SoundTypes.class, new Function<String, SoundType>() {
            ...
            public SoundType apply(String fieldName) {
                ...
                GraniteGameRegistry.this.soundNames.put(soundName, sound);
                return sound;
            }
        });*/
    }
